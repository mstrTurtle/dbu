...
void connectLoginAndDownloadOneSegmentFromVim(Str path, off_t off, size_t size, int part_id);
void downloadOneSegment(SOCK control_socket, SOCK data_socket, Str path, off_t start_offset, size_t size, int part_id);
